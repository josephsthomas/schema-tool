      ...
      <section className="border-b border-zinc-100 dark:border-zinc-900">
        <div className="mx-auto max-w-[1240px] px-6 py-20 md:py-28">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-zinc-700 dark:text-zinc-300">
            Twelve clinical and functional groupings of the schema.org health-lifesci types and
            the health-relevant core types named in the build brief.
          </p>
        </div>
      </section>
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2">
            <div className="rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950">
              <div className="flex items-baseline justify-between gap-2">
                <h3 className="text-xl font-semibold tracking-tight">Enumerations</h3>
                <span className="text-sm text-zinc-500">{dataset.byKind.Enumeration.length}</span>
              </div>
              <p className="mt-2 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
                Closed sets of values used in dropdowns — medical specialties, drug cost
                categories, study designs, and similar.
              </p>
            ...
            <div className="rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950">
              <div className="flex items-baseline justify-between gap-2">
                <h3 className="text-xl font-semibold tracking-tight">Properties</h3>
                <span className="text-sm text-zinc-500">{dataset.byKind.Property.length}</span>
              </div>
              <p className="mt-2 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
                The 163 health-lifesci properties. Each has a detail page; inherited core
                properties like name and url link to schema.org.
              </p>
